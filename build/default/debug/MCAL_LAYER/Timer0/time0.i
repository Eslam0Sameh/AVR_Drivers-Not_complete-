...
# 10 "MCAL_LAYER/Timer0/timer0.h"
# 1 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 1
# 11 "MCAL_LAYER/Timer0/../GPIO/gpio.h"
# 1 "MCAL_LAYER/Timer0/../GPIO/gpio_config.h" 1
# 11 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2
...
# 12 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer0/../GPIO/../std_types.h" 1
# 11 "MCAL_LAYER/Timer0/../GPIO/../std_types.h"
...
# 13 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/std_libs.h" 1
# 11 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/std_libs.h"
...
# 11 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 12 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 13 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/std_libs.h" 2
# 14 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer0/../GPIO/../compiler.h" 1
# 34 "MCAL_LAYER/Timer0/../GPIO/../compiler.h"
...
# 34 "MCAL_LAYER/Timer0/../GPIO/../compiler.h" 2
# 15 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer0/../GPIO/../../MCAL_LAYER/configuration.h" 1
...
# 16 "MCAL_LAYER/Timer0/../GPIO/gpio.h" 2
# 31 "MCAL_LAYER/Timer0/../GPIO/gpio.h"
typedef enum{
    LOW=0,
    HIGH
}logic_t;
...
# 10 "MCAL_LAYER/Timer0/timer0.h" 2

# 1 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_external.h" 1
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_external.h"
# 1 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_declaration.h" 1
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_declaration.h"
# 1 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_conf.h" 1
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_conf.h"
# 1 "MCAL_LAYER/Timer0/../Interrupt/../GPIO/gpio.h" 1
# 69 "MCAL_LAYER/Timer0/../Interrupt/../GPIO/gpio.h"
STD_RETURN gpio_port_direction_initialize(port_index_t port,uint8 direction);
STD_RETURN gpio_port_write(port_index_t port,uint8 logic);
STD_RETURN gpio_port_read(port_index_t port,uint8 *ptr);
STD_RETURN gpio_port_direction_read(port_index_t port,uint8 *ptr);
...
STD_RETURN gpio_pin_read(const pin_config * ptr,logic_t * ptr1);
STD_RETURN gpio_pin_initialize(const pin_config * ptr);
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_conf.h" 2
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_declaration.h" 2
# 10 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_external.h" 2
# 20 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_external.h"
volatile uint8 portb_prev;
# 66 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_external.h"
...
# 1 "MCAL_LAYER/Timer0/../Interrupt/Interrupt_internal.h" 1
# 12 "MCAL_LAYER/Timer0/timer0.h" 2
# 41 "MCAL_LAYER/Timer0/timer0.h"
typedef enum{
...
STD_RETURN TIMER0_Init(const TIMER0_CONF_t *timer0)
{
    ...
    else
    {
        ...
        if((timer0->timer0_prescaler_activation)==1)
        {
            (T0CONbits.PSA=0);
            (T0CONbits.T0PS=timer0->prescaller_value);
        }
        else
        {
            (T0CONbits.PSA=1);
        }
        if((timer0->timer0_8_16_BIT_mode)==1)
            (T0CONbits.T08BIT=1);
        else
            (T0CONbits.T08BIT=0);
        if((timer0->timer0_counter_timer_mode)==0)
        {
            (T0CONbits.T0CS=0);
        }
        else
        {
            ...
            if((timer0->timer0_edge_select)==0)
                (T0CONbits.T0SE=0);
            else
                (T0CONbits.T0SE=1);
        }
