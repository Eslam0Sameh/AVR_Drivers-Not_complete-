...
# 11 "MCAL_LAYER/Timer3/timer3.h"
# 1 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 1
# 11 "MCAL_LAYER/Timer3/../GPIO/gpio.h"
# 1 "MCAL_LAYER/Timer3/../GPIO/gpio_config.h" 1
# 11 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2
...
# 12 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer3/../GPIO/../std_types.h" 1
# 11 "MCAL_LAYER/Timer3/../GPIO/../std_types.h"
...
# 13 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/std_libs.h" 1
# 11 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/std_libs.h"
...
# 11 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 12 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 13 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/std_libs.h" 2
# 14 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer3/../GPIO/../compiler.h" 1
# 34 "MCAL_LAYER/Timer3/../GPIO/../compiler.h"
...
# 34 "MCAL_LAYER/Timer3/../GPIO/../compiler.h" 2
# 15 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2

# 1 "MCAL_LAYER/Timer3/../GPIO/../../MCAL_LAYER/configuration.h" 1
...
# 16 "MCAL_LAYER/Timer3/../GPIO/gpio.h" 2
# 31 "MCAL_LAYER/Timer3/../GPIO/gpio.h"
typedef enum{
    LOW=0,
    HIGH
}logic_t;
...
# 11 "MCAL_LAYER/Timer3/timer3.h" 2

# 1 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_external.h" 1
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_external.h"
# 1 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_declaration.h" 1
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_declaration.h"
# 1 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_conf.h" 1
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_conf.h"
# 1 "MCAL_LAYER/Timer3/../Interrupt/../GPIO/gpio.h" 1
# 69 "MCAL_LAYER/Timer3/../Interrupt/../GPIO/gpio.h"
STD_RETURN gpio_port_direction_initialize(port_index_t port,uint8 direction);
STD_RETURN gpio_port_write(port_index_t port,uint8 logic);
STD_RETURN gpio_port_read(port_index_t port,uint8 *ptr);
STD_RETURN gpio_port_direction_read(port_index_t port,uint8 *ptr);
...
STD_RETURN gpio_pin_read(const pin_config * ptr,logic_t * ptr1);
STD_RETURN gpio_pin_initialize(const pin_config * ptr);
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_conf.h" 2
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_declaration.h" 2
# 10 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_external.h" 2
# 20 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_external.h"
volatile uint8 portb_prev;
# 66 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_external.h"
...
# 1 "MCAL_LAYER/Timer3/../Interrupt/Interrupt_internal.h" 1
# 13 "MCAL_LAYER/Timer3/timer3.h" 2


# 1 "MCAL_LAYER/Timer3/../Timer1/timer1.h" 1
# 10 "MCAL_LAYER/Timer3/../Timer1/timer1.h"
# 1 "MCAL_LAYER/Timer3/../Timer1/../GPIO/gpio.h" 1
# 69 "MCAL_LAYER/Timer3/../Timer1/../GPIO/gpio.h"
STD_RETURN gpio_port_direction_initialize(port_index_t port,uint8 direction);
STD_RETURN gpio_port_write(port_index_t port,uint8 logic);
STD_RETURN gpio_port_read(port_index_t port,uint8 *ptr);
STD_RETURN gpio_port_direction_read(port_index_t port,uint8 *ptr);
...
STD_RETURN gpio_pin_read(const pin_config * ptr,logic_t * ptr1);
STD_RETURN gpio_pin_initialize(const pin_config * ptr);
# 10 "MCAL_LAYER/Timer3/../Timer1/timer1.h" 2
# 49 "MCAL_LAYER/Timer3/../Timer1/timer1.h"
typedef enum{
...
STD_RETURN TIMER3_Init(const TIMER3_CONF_t *timer3)
{
    ...
    else
    {
        ...
        (T3CONbits.T3CKPS=timer3->prescaller_value);
        if((timer3->timer3_counter_timer_mode)==0)
        {
            (T3CONbits.TMR3CS=0);
        }
        else
        {
            ...
            if((timer3->timer3_counter_syn_asyn_mode)==0)
                (T3CONbits.T3SYNC=0);
            else
                (T3CONbits.T3SYNC=1);
        }
        if((timer3->timer1_oscillator_activation)==1)
            (T1CONbits.SOSCEN=1);
        else
            (T1CONbits.SOSCEN=0);
        (T3CONbits.T3RD16=0);
